...
public class PipeSpawner : MonoBehaviour {
    ...
    void SpawnPipe () {
        ...
        float randomVal = Random.Range (holeSize - 0.5f, holeSize + 0.5f);
        newPipeUp.transform.position += Vector3.up * (randomVal / 2);
        newPipeDown.transform.position += Vector3.down * (randomVal / 2);
